...
export default function EditPatientModal({ isOpen, onClose, patientId }) {
  const { patient, refetch, isLoading: patientLoading } = useGetOnePatient(patientId);
  ...
  }, [patientId, isOpen, refetch]);

  useEffect(() => {
    if (patient && patient.filepath) {
      const imageUrl = getBackendImageUrl(patient.filepath);
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-yellow-100 text-sm">Update patient information</p>
              </div>
            </div>
            <button
              onClick={onClose}
              ...
              <form onSubmit={formik.handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-1">
                    <label className="block text-sm font-semibold text-gray-700 mb-4">Patient Photo</label>
                    <div className="space-y-4">
                      ...
                      {currentImage && !imagePreview && (
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                          <p className="text-xs text-blue-700 font-medium">✓ Patient has an existing photo</p>
