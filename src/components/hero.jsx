            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                >
                  ...
                  <span className="block animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
                    Medical Emergencies or
                  </span>
                  <span className="block animate-fadeInUp text-green-600" style={{ animationDelay: "0.6s" }}>
                    Social Causes?
                  </span>
                </h1>
                <div
                  className={`mt-8 sm:mt-10 sm:flex sm:justify-center lg:justify-start transition-all duration-1000 ${isVisible ? "animate-slideInUp opacity-100" : "opacity-0 translate-y-[50px]"}`}
